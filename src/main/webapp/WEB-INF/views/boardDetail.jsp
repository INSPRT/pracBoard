...
<div class="container">
    <form id="form" class="frm" action="" method="post">
        ...
        <table border="1">
            ...
            <tr>
                <td>신청자</td>
                <td>login_id value</td>
                <td>신청일</td>
                <td>${boardDto.report_date}</td>
            </tr>
            <tr>
                <td>이메일</td>
                <td>${boardDto.email}</td>
                <td>핸드폰 번호</td>
                <td>${boardDto.mobile}</td>
            </tr>
            <tr>
                <td>희망교육내용<br>/</br>기타사항</td>
                <td colspan="3">${boardDto.content}</td>
            </tr>
            <tr>
                <td>답변</td>
                <td colspan="3">${boardDto.is_pinned}</td>
            </tr>
        </table>
...
<script>
    $(document).ready(function(){
        ...
        $("#modifyBtn").on("click", function(){
            location.href="/board/modify?bno=${boardDto.bno}&page=${page}&pageSize=${pageSize}";
        });
